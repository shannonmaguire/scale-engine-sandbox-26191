...
export const FeaturedCaseStudy = () => {
  return <StandardCard variant="bordered" className="overflow-hidden hover-lift transition-all duration-300">
      <StandardCardContent className="p-8">
        ...
        <div className="pt-6 border-t">
          <div className="flex items-center justify-between">
            ...
            <Link to="/proof" className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:gap-3 transition-all">
              Read Full Story
