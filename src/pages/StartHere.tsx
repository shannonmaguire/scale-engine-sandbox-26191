...
const StartHere = () => {
  const paths = [
    ...
    },
    {
      ...
      description: "You need technical scoping support or delivery capacity. Request technical assistance to qualify deals, handle objections, or scope implementations.",
      icon: Handshake,
      ctaText: "Request Technical Support",
      ctaLink: "/ae-support",
