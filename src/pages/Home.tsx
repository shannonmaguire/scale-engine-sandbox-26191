...
const Home = () => {
  ...
  return <div className="min-h-screen">
      <EngagementTracker />
      <CookieBanner />
      <SEOHead title="Backend Revenue Systems | CWT Studio" description="Install backend systems that scale without founder dependency. 90-day implementation for legal, compliance, cybersecurity, and B2B SaaS." keywords={['backend revenue systems', 'revenue infrastructure', 'Salesforce optimization', '90-day system installation', 'RevOps consulting', 'high-trust industries']} canonicalUrl="/" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <ConversionOptimizedButton to="/assessment" ctaName="Hero - Start Your Assessment" location="Homepage Hero" size="lg">
                Start Your Assessment
              </ConversionOptimizedButton>
              <ConversionOptimizedButton to="/sample-report" ctaName="Hero - View Sample Report" location="Homepage Hero" variant="outline" showArrow={false} size="lg">
                Sample Report
              </ConversionOptimizedButton>
            </div>
          </div>
      ...
      <Section variant="muted">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="border-l-4 border-primary pl-6 flex flex-col">
              ...
              <div className="space-y-1 mb-4">
                {service.timeline && <div className="text-sm font-mono">
      ...
      <Section>
        <div className="max-w-3xl">
          ...
          <ul className="space-y-3 mb-8">
            {assessmentDeliverables.map((item, index) => <li key={index} className="flex items-start gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <ConversionOptimizedButton to="/assessment" ctaName="Assessment - Start Now" location="Assessment Deliverables Section">
              Start Your Assessment
            </ConversionOptimizedButton>
            <ConversionOptimizedButton to="/sample-report" ctaName="Assessment - View Sample Report" location="Assessment Deliverables Section" variant="outline" showArrow={false}>
              Sample Report
            </ConversionOptimizedButton>
          </div>
        </div>
      ...
      <Section variant="muted">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          {proofStats.map((stat, index) => <div key={index} className="border-l-4 border-primary pl-6">
        ...
        <ConversionOptimizedButton to="/proof" ctaName="By Numbers - See Proof" location="By Numbers Section">
          See Full Case Studies
        </ConversionOptimizedButton>
      </Section>

      {/* Exit Intent Popup */}
      <ExitIntentPopup isOpen={showExitPopup} onClose={() => setShowExitPopup(false)} title="Wait! Get Our Free Guide" description="Join friends and clients getting our comprehensive revenue operations assessment framework." ctaText="Send Me The Guide" />
